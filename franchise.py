...
def page_crawling(search_condition_value, search_condition_sub_value, upjong_value, upjong_sub_value):
    ...
    with webdriver.Chrome(executable_path='/Users/miae/Desktop/yeardream/project/chromedriver') as driver:
        ...
        for td in tr:
            ...
            if search_condition_sub_value == 'listIndus01':
                arr = condition_menu
            elif search_condition_sub_value == 'listIndus02':
                arr = headquarters_menu
            elif search_condition_sub_value == 'listIndus03':
                arr = brand_menu
            elif search_condition_sub_value == 'listIndus04':
                arr = affiliate_menu
            # search_condition_value == '2'
            elif search_condition_sub_value == 'listHq01':
                arr = growth_menu
            ...
            elif search_condition_sub_value == 'listBrand01':
                arr = outline_menu
